...
// display 區
import calmieFront from "../assets/images/clean-shot-front.avif"
import calmieLeft from "../assets/images/clean-shot-left.avif"
...
const DescArea = () => {
  ...
  const product = {id:4, name:"Clean Shot \n 高效粉刺清潔儀", price:6280, img:calmieFront};
  return (
    <div className="product-text-area">
      <h2 className="title">ELOA CleanShot  高效粉刺清潔儀</h2>
      <p className="subtitle">362人今天瀏覽過</p>
      ...
      <p className="desc">
        ELOA CleanShot 採用熱感循環軟化膚表，加強毛孔開啟，結合三段吸力調節的真空吸附設計，能精準清除黑頭白頭、粉刺與堆積油脂。
        專為亞洲膚質與鼻翼等高敏感區設計，並附多種吸頭選擇，溫和不拉扯，提升清潔效率與舒適度。
        肌膚清潔不該再靠擠壓與磨擦，讓科技取代暴力保養。
      </p>
      ...
      <p className="price">售價 NT$6,280</p>
      {/* 購物操作區 */}
...
const DescTab = () => {
  ...
  const tabContent = {
    product: {
      title: "不只是冰敷，ELOA CleanShot 能成為妳每日保養的「收尾儀式」。",
    ...
    specs: {
      ...
      alt: "規格說明圖示",
      spec: [
        { specification: "吸力強度：三段可調（最大達65kPa）" },
        { specification: "熱循環功能：穩定輸出約42°C" },
        { specification: "吸頭數量：4款（圓孔 / 橢圓孔 / 微鑽 / 精細）" },
        { specification: "電源供應：USB Type-C 充電" },
        { specification: "面板顯示：LED電量與模式指示" }
      ]
    },
    teaching: {
      title: "不只是冰敷，ELOA CleanShot 能成為妳每日保養的「收尾儀式」。",
  ...
  const faqData = [
    {
      id: 'q1',
      question: '每天可以用嗎？',
      answer: 'A：建議1週使用2~3次即可，避免過度清潔造成刺激。'
    },
    {
      id: 'q2',
      question: '吸頭怎麼清洗？',
      answer: 'A：吸頭可用中性洗劑與清水沖洗，再以酒精擦拭消毒後自然風乾。'
    },
    {
      id: 'q3',
      question: '需要事先做降溫準備嗎？',
      answer: 'A：不需要。CleanShot 內建智能冷凝系統，可自動降溫至穩定溫度，無需額外冷藏或耗材。'
    },
    {
      id: 'q4',
      question: '每天可以使用幾次？',
  ...
  const customersMessages = [
    {
      ...
      name: "小青子",
      date: "July 7, 2025",
      feedback: "吸完粉刺很乾淨但不會紅，用完搭配保濕整個膚質滑順超舒服！"
    },
    {
      id: 2,
      avatar: avatar2,
