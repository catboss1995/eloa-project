...
import primarybg1Mobile from "../assets/images/primary1-350.avif"
import primarybg2Mobile from "../assets/images/primary2-350.avif"
import primarybg3Mobile from "../assets/images/primary3-350.avif"
import primarybg4Mobile from "../assets/images/primary4-350.avif"
import primarybg1Table from "../assets/images/primary1-768.avif"
import primarybg2Table from "../assets/images/primary2-768.avif"
import primarybg3Table from "../assets/images/primary3-768.avif"
import primarybg4Table from "../assets/images/primary4-768.avif"
import primarypd1 from "../assets/images/primary-1-product1.avif"
import primarypd2 from "../assets/images/primary-1-product2.avif"
import primarypd3 from "../assets/images/primary-1-product3.avif"
import primarypd4 from "../assets/images/primary-1-product4.avif"
...
// product 區
import decorateHuman from "../assets/images/product-sec-bg-decorate-human.avif"
import decorateProducts from "../assets/images/product-sec-bg-decorate-products.webp"
import cardProduct1 from "../assets/images/product-sec-card-product1.avif"
import cardProduct2 from "../assets/images/product-sec-card-product2.avif"
import cardProduct3 from "../assets/images/product-sec-card-product3.avif"
...
// app 區
import appBG from "../assets/images/app-sec-bg.avif"
import appHuman from "../assets/images/app-sec-human.avif"
// campaign 區
...
const CarouselSlides = ({ currentSlide }) => {
  const slideData = {
    ...
    productSlides: [
      {
        background: primarybg1,
        mobileBg: primarybg1Mobile,
        tableBg: primarybg1Table,
        product: primarypd1,
        layout: 'right',
        slogan: {
      ...
      {
        background: primarybg2,
        mobileBg: primarybg2Mobile,
        tableBg: primarybg2Table,
        product: primarypd2,
        layout: 'left',
        slogan: {
      ...
      {
        background: primarybg3,
        mobileBg: primarybg3Mobile,
        tableBg: primarybg3Table,
        product: primarypd3,
        layout: 'right',
        slogan: {
      ...
      {
        background: primarybg4,
        mobileBg: primarybg4Mobile,
        tableBg: primarybg4Table,
        product: primarypd4,
        layout: 'left',
        slogan: {
          en: "The Rhythm of\n Skincare Starts Within.",
  ...
  return (
    <>
      ...
      {/* 2~5 - 產品 */}
      {slideData.productSlides.map((slide, index) => {
        const slideNumber = index + 2;
        const isLeftLayout = slide.layout === 'left';
          ...
          >
            <picture>
              ...
              <img
                ...
                className="primary-caroual2"
              />
            </picture>

            <img
              src={slide.product}
              alt={`primary-product${slideNumber - 1}`}
              className={isLeftLayout ? "primary-product-left" : "primary-product"}
            />

            <article className={isLeftLayout ? "product-slogan-right" : "product-slogan"}>
              <p className="slogan-en">{slide.slogan.en}</p>
              <p className="slogan-zh">{slide.slogan.zh}</p>
            </article>
          </div>
        );
      })}
...
// 產品推廣區元件
const ProductImages = ({ offsetY, backPic, frontPic }) => {
  return (
    <>
      <img
        src={backPic}
        alt="Master IX backPic"
        id="backPic"
        style={{ transform: `translateY(${-offsetY}px)` }}
      />
      <img
        src={frontPic}
        alt="Master IX frontPic"
        id="frontPic"
        style={{ transform: `translateY(${offsetY}px)` }}
      />
    </>
...
const ProductSecCard = ({ picUrl, picNameEn, picNameZh, picNameDesc1, picNameDesc2, iconUrl1, iconDesc1, iconUrl2, iconDesc2, iconUrl3, iconDesc3, link }) => {
  return (
...
const Home = () => {
  ...
  const ProductMouseMove = (e) => {
    ...
    setOffsetY((prev) => {
      let newOffset = prev + scrollAmount / 15; // 除以 10 調整靈敏度
      if (newOffset > 50) newOffset = 50;      // 最大位移
      if (newOffset < -50) newOffset = -50;    // 最小位移
      return newOffset;
    });
  }
  useEffect(() => {
      ...
      <section className="h100-vh" id="product-sec">
        ...
        <div className="product-sec-layout">
          ...
          <div className="product-sec-cards-container">
            <ProductSecCard picUrl={cardProduct1} picNameEn={"ELOA Calmie"} link={"/ProductCalmie"} picNameZh={"恆溫冷敷舒緩儀"} picNameDesc1={"即刻舒緩，重啟膚觸平衡。"} picNameDesc2={"智能冷凝技術改善泛紅、刺激與緊繃。"} iconUrl1={sensitiveSkin} iconDesc1={"敏感肌"} iconUrl2={oilySkin} iconDesc2={"油性肌"} iconUrl3={drySkin} iconDesc3={"乾性肌"} />
            <ProductSecCard picUrl={cardProduct2} picNameEn={"ELOA Aura Clean"} link={"/ProductAuraClean"} picNameZh={"淨膚導出清潔儀"} picNameDesc1={"結合微震導出與淨化循環技術，"} picNameDesc2={"清除毛孔內部油脂與老廢角質，改善粉刺與粗糙膚況。"} iconUrl1={combinationSkin} iconDesc1={"混合肌"} iconUrl2={oilySkin} iconDesc2={"油性肌"} iconUrl3={hotSkin} iconDesc3={"熱銷款"} />
            <ProductSecCard picUrl={cardProduct3} picNameEn={"ELOA GlowPen"} link={"/ProductGlowPen"} picNameZh={"智慧亮膚導入筆"} picNameDesc1={"採用微電流與紅光同步導入技術，"} picNameDesc2={"提升精華吸收效率，改善暗沉、膚色不均與乾燥細紋。"} iconUrl1={newArrivalSkin} iconDesc1={"新上市"} iconUrl2={drySkin} iconDesc2={"乾性肌"} iconUrl3={combinationSkin} iconDesc3={"混合肌"} />
            <ProductSecCard picUrl={cardProduct4} picNameEn={"ELOA CleanShot"} link={"/ProductCleanShot"} picNameZh={"高效粉刺清潔儀"} picNameDesc1={"結合震動吸附與熱循環深導功能，"} picNameDesc2={"迅速帶走黑頭與油脂堆積，暢通毛孔、減少粉刺生成。"} iconUrl1={newArrivalSkin} iconDesc1={"新上市"} iconUrl2={oilySkin} iconDesc2={"油性肌"} iconUrl3={acneSkin} iconDesc3={"痘痘肌"} />
          </div>
        </div>
      </section>
