...
const DescArea = () => {
  ...
  const product = {id:2, name:"Aura Clean \n 淨膚導出清潔儀", price:5980, img:calmieFront};
  return (
    <div className="product-text-area">
      <h2 className="title">ELOA Aura Clean 淨膚導出清潔儀</h2>
      <p className="subtitle">342人今天瀏覽過</p>
      ...
      <p className="desc">
        搭載高速微震導出技術，有效震碎毛孔內皮脂栓塞與老廢角質，改善粉刺、暗沉與粗糙問題。再結合拋光式鋼板設計，讓潔淨更深入、肌膚更柔亮。
        內建水洗可拆結構，輕鬆清潔不藏污，搭配導出模式與噴霧濕潤使用，溫和又高效。
        日常潔淨的新選擇，讓洗臉後不再只是表面清潔。
      </p>
      ...
      <p className="price">售價 NT$5,980</p>
      {/* 購物操作區 */}
...
const DescTab = () => {
  ...
  const tabContent = {
    product: {
      title: "不只是冰敷，ELOA Aura Clean 能成為妳每日保養的「收尾儀式」。",
    ...
    specs: {
      ...
      alt: "規格說明圖示",
      spec: [
        { specification: "超音波導出頻率：每分鐘 10,000 次震動" },
        { specification: "導出板材質：304 醫療級不鏽鋼" },
        { specification: "操作模式：2 段強度可調" },
        { specification: "供電方式：USB Type-C" },
        { specification: "本體防水等級：IPX5" }
      ]
    },
    teaching: {
      title: "不只是冰敷，ELOA Aura Clean 能成為妳每日保養的「收尾儀式」。",
  ...
  const faqData = [
    {
      id: 'q1',
      question: '乾用可以嗎？',
      answer: 'A：建議於肌膚濕潤時使用導出模式，效果更佳且避免拉扯。'
    },
    {
      id: 'q2',
      question: '使用時會感到刺痛或不適嗎？',
      answer: 'A：震動導出溫和不痛，適度使用即可減少敏感機率。'
    },
    {
      id: 'q3',
      question: '需要事先做降溫準備嗎？',
      answer: 'A：不需要。Aura Clean 內建智能冷凝系統，可自動降溫至穩定溫度，無需額外冷藏或耗材。'
    },
    {
      id: 'q4',
      question: '每天可以使用幾次？',
  ...
  const customersMessages = [
    {
      ...
      name: "小青子",
      date: "July 7, 2025",
      feedback: "鼻翼粉刺改善超有感，用完很滑順，溫和又不會紅！"
    },
    {
      id: 2,
      avatar: avatar2,
